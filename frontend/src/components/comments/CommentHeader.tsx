...
const CommentHeader = ({ comment, replyText, submitReplyHandler, setReplyValue, setIsOpenCommentInput, isOpenCommentInput, updateCommentHandler }: CommentHeaderPropTypes) => {
    ...
    return <>
        <div className="w-full select-none flex flex-col justify-start items-start gap-2 ml-2">
            ...
            <CommentActions openCommentInputBoxHandler={openCommentInputBoxHandler} comment={comment} updateCommentHandler={updateCommentHandler} />
