    ...
    return (
        <>
            <div className="flex flex-col justify-start items-start mb-3">
                ...
                {
                    errors.title && (
                        <span className='text-red-500 text-xs font-bold pl-1'>{errors.title.message}</span>
                    )
                }
            </div>
            ...
            <div className="flex flex-col justify-start items-start mb-3">
                ...
                />
                {errors.recipe && (
                    <span className='text-red-500 text-xs font-bold pl-1'>{errors.recipe.message}</span>
                )}
            </div>
            <ImageUploader />
        </>)
