        ...
        <>
            <div className="flex flex-col justify-start items-center mb-3">
                ...
                <input id='title' type='text'
                    className="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-2 border-gray-200 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Write your caption here..."
                    {...register("title", { required: "A title is must!" })}
                />
                {
                    errors.title && (
            ...
            <div className="flex flex-col justify-start items-center mb-3">
                ...
                <textarea id='recipe'
                    rows={5}
                    className="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-2 border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Write your recipe or about yummy things here..."
                    {...register('recipe')}
                />
                {errors.recipe && (
                    <span className='text-red-500 text-xs'>{errors.recipe.message}</span>
                )}
            </div>
            <ImageUploader />
        </>)
